              ...
              return (
                <>
                  <div className="flex flex-col items-center mr-1">
                    <Balance address={account.address as Address} className="min-h-0 h-auto text-gray-900 font-bold" />
                    <span className="text-xs text-gray-900 font-semibold">{chain.name}</span>
                  </div>
                  <AddressInfoDropdown
